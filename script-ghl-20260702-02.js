(function () {
  ...
  function cleanupGhlDuplicateEmbeds() {
    ...
    const latest = styleLinks.find((link) => link.href.includes("styles-ghl-20260702-02.css"))
  ...
  function normalizeGhlFormFrame() {
    ...
    const frameHeight = mobile ? "900px" : "900px";
    iframe.style.height = frameHeight;
    iframe.style.minHeight = frameHeight;
    iframe.style.overflow = "hidden";
    iframe.setAttribute("data-height", mobile ? "900" : "900");
