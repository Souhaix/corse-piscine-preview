(function () {
  ...
  function cleanupGhlDuplicateEmbeds() {
    ...
    const latest = styleLinks.find((link) => link.href.includes("styles-ghl-20260702-01.css"))
  ...
  function normalizeGhlFormFrame() {
    ...
    const frameHeight = mobile ? "860px" : "860px";
    iframe.style.height = frameHeight;
    iframe.style.minHeight = frameHeight;
    iframe.setAttribute("data-height", "860");
